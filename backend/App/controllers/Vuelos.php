     ...
     foreach ($vuelos as $key => $value) {
            ...
            <tr>
                ...
                <td style="text-align:center; vertical-align:middle;">
                    ...
                    <button class="btn bg-gray btn-icon-only btn-iframe-uno" data-borrar="{$value['id_pase_abordar']}" data-document="{$value['link']}" type="button" data-toggle="modal" data-target="#modal-ver-pdf-{$value['id_pase_abordar']}" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-original-title="Ver .PDF Pase de Abordar de {$value['nombre']} - {$value['id_pase_abordar']}"><span class="fas fa-eye" style="color: white;"></span></button>
